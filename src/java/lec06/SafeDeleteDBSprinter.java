...
@WebServlet("/SafeDeleteDBSprinter")
public class SafeDeleteDBSprinter extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            Logger.getLogger(SafeDeleteDBSprinter.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        out.println("<form action=\"./SafeDeleteDBSprinter\" method=\"POST\">");
